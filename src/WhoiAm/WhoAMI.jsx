  ...
  return (
    <div className="intro-container">
      <div className="intro-text">
        <h1 className="intro-h1">This is,</h1>
        <h2 className="intro-h2">Aritra Mandal</h2>
          ...
          <a href="https://www.linkedin.com/in/aritra-mandal-136b5b217/">
            ...
            >
              <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 
                ...
                5.183c.837 0 1.358-.554 1.358-1.248-.015-.709-.52-1.248-1.342-1.248-.822 
                0-1.343.54-1.343 1.248 0 .694.521 1.248 1.327 
                1.248h.016zm4.908 8.211V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 
      ...
      <div className="intro-image">
        <img src="./my-image.jpg" alt="Aritra Mandal" />
      </div>
    </div>
  );
};
